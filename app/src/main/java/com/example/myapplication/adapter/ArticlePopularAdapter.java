...
public class ArticlePopularAdapter extends RecyclerView.Adapter<ArticlePopularAdapter.ItemViewHolder> {
    ...
    private ArticlePopularAdapter.OnItemClickListener clickListener;

    public void setOnItemClickListener(ArticlePopularAdapter.OnItemClickListener listener) {
        this.clickListener = listener;
    }

    public ArticlePopularAdapter(Context context, List<ArticleModel> itemList) {

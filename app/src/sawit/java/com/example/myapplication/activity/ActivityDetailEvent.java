...
public class ActivityDetailEvent extends AppCompatActivity {
    ...
    private String title,img,content,tanggal,link;
    private TextView tvContent,tvTitle,tvTitleToolbar, tvDate,tvDateEvent,tvLink;
    ...
    private CollectionReference commentsCollection = firestore.collection("Event");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitleToolbar.setText("Detail Event");
        ...
        commentAdapter = new CommentAdapter(ActivityDetailEvent.this,commentModelList);
    ...
    private void sendMessage(){
        ...
        db.collection("Event")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    // Update commentCount di koleksi event
                    updateCommentCount();
                })
